...
这些指标不是行程“准确率”、实时高德质量、酒店可订性、预算满足率或生产 SLA。候选目录属于开发 fixture，计划尚未经过下一阶段的营业时间、must/avoid、路线时间窗等 Hard Validators，也没有 Repair Router。因此简历中应描述为“版本化 grounding/lineage regression”，不能写成“真实用户行程成功率 100%”。
